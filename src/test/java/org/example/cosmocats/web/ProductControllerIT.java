...
class ProductControllerIT extends AbstractIt {
  ...
  void createProduct_shouldReturn400_whenNameIsBlank() throws Exception {
    ProductDetailsDto invalidDto = validDto.toBuilder().name("").build();
  ...
  void createProduct_shouldReturn400_whenPriceIsNegative() throws Exception {
    ProductDetailsDto invalidDto = validDto.toBuilder().price(-10.0).build();
  ...
  void createProduct_shouldReturn400_whenSkuIsInvalid() throws Exception {
    ProductDetailsDto invalidDto = validDto.toBuilder().sku("invalid sku pattern").build();
  ...
  void getProductById_shouldReturn200_whenFound_withSupplierInfo() throws Exception {
    ...
    stubFor(
        com.github.tomakehurst.wiremock.client.WireMock.get(urlEqualTo("/suppliers/info/" + sku))
            .willReturn(
                aResponse()
                    .withStatus(200)
  ...
  void updateProduct_shouldReturn200_whenValid() throws Exception {
    ...
    ProductDetailsDto updateDto =
        validDto.toBuilder().name("Updated Galaxy").sku("SKU-UPD-001").build();
