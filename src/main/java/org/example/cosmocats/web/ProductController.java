...
public class ProductController {
  ...
  @PostMapping
  public ResponseEntity<ProductDetailsEntry> createProduct(
      @Valid @RequestBody ProductDetailsDto productDto) {
  ...
  @PutMapping("/{id}")
  public ResponseEntity<ProductDetailsEntry> updateProduct(
      @PathVariable Long id, @Valid @RequestBody ProductDetailsDto productDto) {
